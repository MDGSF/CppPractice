...
String::String(const String &rhs) {
  ...
  first_free = std::uninitialized_copy(rhs.begin(), rhs.end(), first_elem);
  cap = first_free;
}
...
String &String::operator=(const String &rhs) {
  ...
  auto new_first_free =
      std::uninitialized_copy(rhs.begin(), rhs.end(), new_first_elem);
  free();
...
std::string String::str() const { return std::string(cbegin(), cend()); }
